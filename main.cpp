...
int main(int, char **)
{
    ...
    auto instrument2 = Instrument();
    instrument2._name = "Instrument2";
    instrument2._midiChannel = 0;
    instrument2._plugin = nullptr;
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        ImGui::Begin("Inspector", nullptr, ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoTitleBar);
        {
            ...
            ImGui::Text("EQ");
            ImGui::NextColumn();
            ImRect bb(wnd->DC.CursorPos, ImVec2(wnd->DC.CursorPos.x + 100, wnd->DC.CursorPos.y + 50));
            ImGui::ItemSize(bb);
            ImGui::NextColumn();
            bb = ImRect(wnd->DC.CursorPos, ImVec2(wnd->DC.CursorPos.x + 100, wnd->DC.CursorPos.y + 50));
            ImGui::ItemSize(bb);
            ImGui::NextColumn();
